...
public class AVFrame {
	...
	public static final int MEDIA_CODEC_AUDIO_G711 = 0x90;
	public static final int MEDIA_CODEC_AUDIO_AAC = 0X91;
	...
	//public int aFrmSize =0;
	//public byte [] aFrmData =null;
	//private short aCodec_id = 0;
	...
	public AVFrame(long frameNo,byte frameState,byte fmt,byte[] TimeStamp,short codeid,int w,int h,int size,byte[]frameData){
		codec_id = codeid;
		videoWidth = w;
		videoHeight = h;
		frmSize = size;
		...
		frmState = frameState;
		flags = fmt;
		timestamp = Packet.byteArrayToInt_Little(TimeStamp, 12);
	}
	
	public AVFrame(int size,short codeid,byte[]frameData){
		codec_id = codeid;
		frmSize = size;
		frmData = frameData;
	}
	...
	//public int getaFrameSize(){
	//	return aFrmSize;
	//}
	//public short getaCodecid(){
	//	return aCodec_id;
	//}
	//public byte[] getaFrameData(){
	//	return aFrmData;
	//}
}
