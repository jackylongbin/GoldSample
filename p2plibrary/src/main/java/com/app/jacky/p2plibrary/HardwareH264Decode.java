package com.app.jacky.p2plibrary;
...
import com.tutk.IOTC.IVideoDecoder;

import java.io.IOException;
import java.nio.ByteBuffer;

public class HardwareH264Decode implements IVideoDecoder {
    private static final String TAG = "HardwareH264Decode";
    //解码后显示的surface及其宽高
     ...
     * 初始化解码器
     *
     * @param surface 用于显示视频的surface
     * @param width  surface宽
     * @param height surface高
     */
    public HardwareH264Decode(Surface surface, int width, int height) {
    ...
    private void initDecoder() {
        try {
            ...
            Log.w(TAG,"H264 decoder create failed:" + e.getMessage());
        }
        //初始化MediaFormat
        ...
        Log.d(TAG,"Decode create success and started.");
    }
